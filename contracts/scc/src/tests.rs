...
mod tests {
    ...
    use cosmwasm_std::{coins, from_binary, Coin, Addr, Response, Uint128, Decimal};
    use crate::state::{USER_REWARD_INFO_MAP, UserRewardInfo, STATE, State, STRATEGY_MAP, StrategyInfo};
